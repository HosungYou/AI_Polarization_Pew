...
# ── Paths ──────────────────────────────────────────────────────────
BASE = "/Users/hosung/AI_Polarization_Pew/paper2_ai_divide"
...
def insert_table_by_number(doc, tbl_num):
    ...
    if tbl_num == 1:
        add_apa_table(
            ...
            [
                ["A", "2", "\u2014", "\u2014", "39,812", "0.712", "42.1%"],
                ["A", "3", "\u2014", "\u2014", "38,945", "0.681", "15.3%"],
                ["A", "4*", "\u2014", "\u2014", "38,539", "0.659", "9.0%"],
                ["A", "5", "\u2014", "\u2014", "38,412", "0.618", "6.2%"],
                ["B", "2", "\u2014", "\u2014", "39,524", "0.698", "43.8%"],
                ["B", "3", "\u2014", "\u2014", "38,710", "0.665", "16.1%"],
                ["B", "4*", "\u2014", "\u2014", "38,344", "0.643", "10.6%"],
                ["B", "5", "\u2014", "\u2014", "38,201", "0.596", "4.8%"],
            ],
